package com.hi.data.plugin.viewclick

import com.hi.data.plugin.ClassNameAnalytics
import com.hi.data.plugin.configs.SensorsAnalyticsHookConfig
import com.hi.data.plugin.fragment.SensorsFragmentHookConfig
import com.hi.data.plugin.manager.SAPackageManager
import com.hi.data.plugin.manager.SAPluginManager
import com.hi.data.plugin.utils.Logger.warn
import com.hi.data.plugin.utils.SAUtils
...
class SensorsAutoTrackMethodVisitor(
    ...
    override fun visitEnd() {
        ...
        if (isHasTracked) {
            ...
            visitAnnotation(
                "Lcom/hi/data/sdk/SensorsDataInstrumented;",
                false
            )
        }
    }
    ...
    override fun visitAnnotation(s: String, b: Boolean): AnnotationVisitor {
        if (s == "Lcom/hi/data/sdk/SensorsDataTrackViewOnClick;") {
            isSensorsDataTrackViewOnClickAnnotation = true
        } else if (s == "Lcom/hi/data/sdk/SensorsDataIgnoreTrackOnClick;") {
            isSensorsDataIgnoreTrackOnClick = true
        } else if (s == "Lcom/hi/data/sdk/SensorsDataInstrumented;") {
            isHasInstrumented = true
        } else if (s == "Lcom/hi/data/sdk/SensorsDataTrackEvent;") {
